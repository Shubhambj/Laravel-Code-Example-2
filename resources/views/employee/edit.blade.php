                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                                <form class="form-material" action="{{ route('employee.update', ['id' => $employee->id]) }}" method="post" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PATCH')
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="form-group form-default">
                                                                            ...
                                                                            <input type="text" name="date_of_birth" value="{{ $employee->dob ?? '' }}" placeholder="YYYY-MM-DD">
                                                                    ...
                                                                    <div class="col-md-9">
                                                                        ...
                                                                        @foreach($roles as $role)
                                                                            <div class="form-check form-check-inline">
                                                                                <input class="form-check-input" type="checkbox" name="roles[]" id="{{ $str::slug($role->name, '_') }}" value="{{ $role->id }}" {{ in_array($role->id, $dbRoles) ? 'checked' : '' }}/>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                @if(!empty($employee->image))
                                                                    <img src="{{ asset('storage/images/users/'.$employee->image) }}" height="150" width="150" class="img-radius" alt="">
                                                                @endif
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input is_address_same" type="radio" name="is_address_same" id="is_address_same_yes" value="1" {{ (int)$employee->is_address_same === 1 ? 'checked' : '' }}/>
                                                            <label class="form-check-label" for="is_address_same_yes">Yes</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input is_address_same" type="radio" name="is_address_same" id="is_address_same_no" value="0" {{ (int)$employee->is_address_same === 0 ? 'checked' : '' }}/>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group form-default">
                                                                    ...
                                                                    <input type="text" name="current_address_line_one" value="{{ $employee->addresses[0]->line_one ?? '' }}">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group form-default">
                                                                    ...
                                                                    <input type="text" name="current_address_line_two" value="{{ $employee->addresses[0]->line_two ?? '' }}">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group form-default">
                                                                    ...
                                                                    <select class="select2" name="current_address_city">
                                                                        ...
                                                                        <option value="{{ $city->id }}" {{ isset($employee->addresses[0]) && $employee->addresses[0]->city_id === $city->id ? 'selected' : '' }}>{{ $city->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <div class="form-group form-default">
                                                                    ...
                                                                    <select class="select2" name="current_address_state">
                                                                        ...
                                                                        @foreach($states as $state)
                                                                            <option value="{{ $state->id }}" {{ isset($employee->addresses[0]) && $employee->addresses[0]->state_id === $state->id ? 'selected' : '' }}>{{ $state->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                        ...
                                                        <div id="permanent_address_container" style="display: {{ (int)$employee->is_address_same === 1 ? 'none' : 'block' }};">
                                                            <h4 class="sub-title">Permanent Address</h4>
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    <div class="form-group form-default">
                                                                        <label class="col-form-label" style="display:block;">Address Line 1</label>
                                                                        <input type="text" name="permanent_address_line_one" value="{{ $employee->addresses[1]->line_one ?? '' }}">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group form-default">
                                                                        <label class="col-form-label" style="display:block;">Address Line 2</label>
                                                                        <input type="text" name="permanent_address_line_two" value="{{ $employee->addresses[1]->line_two ?? '' }}">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group form-default">
                                                                        ...
                                                                        <select class="select2" name="permanent_address_city">
                                                                            <option value="" disabled selected>Select City</option>
                                                                            @foreach($cities as $city)
                                                                                <option value="{{ $city->id }}" {{ isset($employee->addresses[1]) && $employee->addresses[1]->city_id === $city->id ? 'selected' : '' }}>{{ $city->name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group form-default">
                                                                        ...
                                                                        <select class="select2" name="permanent_address_state">
                                                                            <option value="" disabled selected>Select State</option>
                                                                            @foreach($states as $state)
                                                                                <option value="{{ $state->id }}" {{ isset($employee->addresses[1]) && $employee->addresses[1]->state_id === $state->id ? 'selected' : '' }}>{{ $state->name }}</option>
                                                                            @endforeach
                                                                        </select>
